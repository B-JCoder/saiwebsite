...
import { FaLaptopCode, FaCheckCircle, FaGraduationCap, FaUniversity } from "react-icons/fa";
import { ArrowRight } from "lucide-react";
import Link from "next/link";

export default function ComputerSciencePage() {
    const subjects = ["Computer Science", "Mathematics", "Physics / Statistics", "English", "Urdu", "Islamiat"];
    const careers = ["Software Development", "Data Science", "Artificial Intelligence", "Cyber Security", "Robotics", "IT Management"];
        ...
        <div className="min-h-screen bg-white">
                ...
                <div className="relative z-10 text-center px-6">
                    ...
                    >
                        ...
                        <p className="text-white/80 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-light">
                            Cutting-edge computer science education focusing on programming, logic, and innovation.
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 container mx-auto">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-4xl font-black text-[#800000] uppercase mb-6">Mastering Technology</h2>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center gap-3 font-medium text-gray-800">
                                <FaCheckCircle className="text-[#DAA520]" /> Modern Computer Labs
                            </li>
                            <li className="flex items-center gap-3 font-medium text-gray-800">
                                <FaCheckCircle className="text-[#DAA520]" /> Coding & Programming Workshops
                            </li>
                            <li className="flex items-center gap-3 font-medium text-gray-800">
                                <FaCheckCircle className="text-[#DAA520]" /> Career Counseling in IT
                            </li>
                        </ul>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">Passed with Science group.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-white rounded-xl shadow-sm">
                        ...
                        <Link href="/admissions" className="mt-8 block w-full bg-slate-900 text-white text-center py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-[#DAA520] hover:text-black transition-colors">
                            Apply for Admission
                        </Link>
                    </motion.div>
                </div>
