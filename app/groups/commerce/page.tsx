...
import { FaCalculator, FaCheckCircle, FaGraduationCap, FaUniversity } from "react-icons/fa";
import { ArrowRight } from "lucide-react";
import Link from "next/link";

export default function CommercePage() {
    const subjects = ["Accounting", "Principles of Commerce", "Economics", "Business Math", "English", "Urdu"];
    const careers = ["Chartered Accountancy (CA)", "ACCA", "Business Administration (BBA)", "Banking & Finance", "Entrepreneurship", "Marketing"];
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 bg-emerald-900">
                    ...
                    <div className="absolute inset-0 opacity-20 bg-[url('/images/hero-bg.jpg')] bg-cover bg-center mix-blend-overlay" />
                </div>
                ...
                <div className="relative z-10 text-center px-6">
                    ...
                    >
                        ...
                        <p className="text-white/80 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-light">
                            Building foundations in accounting, economics, and business management.
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 container mx-auto">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-4xl font-black text-[#800000] uppercase mb-6">Business Leadership</h2>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center gap-3 font-medium text-gray-800">
                                <FaCheckCircle className="text-[#DAA520]" /> Fundamentals of Accounting
                            </li>
                            <li className="flex items-center gap-3 font-medium text-gray-800">
                                <FaCheckCircle className="text-[#DAA520]" /> Entrepreneurship Seminars
                            </li>
                            <li className="flex items-center gap-3 font-medium text-gray-800">
                                <FaCheckCircle className="text-[#DAA520]" /> Internship Opportunities
                            </li>
                        </ul>
                    </motion.div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">Passed with Science/Arts/Commerce.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-white rounded-xl shadow-sm">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">50% or above in aggregate.</p>
                                </div>
                            </div>
                        </div>
                        <Link href="/admissions" className="mt-8 block w-full bg-emerald-900 text-white text-center py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-[#DAA520] hover:text-black transition-colors">
                            Apply for Admission
                        </Link>
                    </motion.div>
                </div>
