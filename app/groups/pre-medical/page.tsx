        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Our Pre-Medical program is rigorously designed to prepare students
              for entrance into top medical colleges (MBBS/BDS). We focus on
              conceptual clarity in Biology, Physics, and Chemistry, ensuring
              students excel in both Board Exams and MDCAT.
            </p>
            <ul className="space-y-4">
              <li className="flex items-center gap-3 font-medium text-gray-800">
                <FaCheckCircle className="text-[#DAA520]" /> Expert Faculty for
                MDCAT Prep
              </li>
              <li className="flex items-center gap-3 font-medium text-gray-800">
                <FaCheckCircle className="text-[#DAA520]" /> State-of-the-Art
                Biology Labs
              </li>
              <li className="flex items-center gap-3 font-medium text-gray-800">
                <FaCheckCircle className="text-[#DAA520]" /> Regular Assessment
                & Seminars
              </li>
            </ul>
          </motion.div>
          ...
          >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Passed with Science (Biology) group.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
            ...
            <Link
              href="/admissions"
              className="mt-8 block w-full bg-[#800000] text-white text-center py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-[#DAA520] transition-colors"
            >
              Apply for Admission
            </Link>
          </motion.div>
