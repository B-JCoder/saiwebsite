  ...
  return (
    <div className="pt-32 pb-20 container mx-auto px-6">
      <div className="text-center mb-16">
        <span className="uppercase text-sm font-bold text-[#DAA520] tracking-widest block mb-2">
          Resources
        </span>
        <h1 className="text-4xl md:text-6xl font-heading font-black text-[#800000] uppercase tracking-tighter mb-6">
          Downloads
        </h1>
      ...
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        <div className="bg-white p-6 rounded-xl shadow border border-gray-100 flex items-center justify-between hover:border-[#800000] transition-colors group">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-black group-hover:text-[#800000] transition-colors">
                Admission Form 2024
              </h3>
        ...
        <h3 className="text-2xl font-bold text-[#800000] border-l-4 border-[#DAA520] pl-4 mb-4">
          Examinations
        </h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow border border-gray-100 flex items-center justify-between hover:border-[#800000] transition-colors group">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-black group-hover:text-blue-800 transition-colors">
                Date Sheet - HSC Part I & II (Annual 2024)
              </h3>
