...
export default function AboutUs() {
  ...
  // Vision Text Reveal
  const visionQuote =
    "We draw our vision from Quaid-i-Azam’s speech delivered on 27th November, 1947 at Karachi where he condemned “education for sake of education” and emphasized on “Education for sake of Character-building”.";
  ...
  return (
    <div className="bg-white min-h-screen font-sans selection:bg-[#800000] selection:text-white">
      <PageHeader
        title="About Us"
        subtitle="Sir Adamjee Institute (SAI)"
        imageSrc="/images/sai-img-1 (9).jpeg"
      />
      {/* 
      ...
      */}
      <section className="relative py-32 bg-white flex items-center justify-center overflow-hidden">
        {/* Noise Overlay */}
        <div
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <h3 className="text-3xl md:text-5xl lg:text-6xl font-serif text-black leading-tight max-w-6xl mx-auto">
            {visionWords.map((word, i) => (
              <span
                key={i}
                className="inline-block overflow-hidden align-top mr-2 md:mr-3"
              >
                <motion.span
                  ...
                  transition={{
                    ...
                    delay: i * 0.02, // Faster staggering for longer text
                  }}
                >
                  {word}
                </motion.span>
          ...
          <motion.p
            ...
            className="mt-8 text-gray-500 font-medium italic"
          >
            — Inspired by Quaid-i-Azam’s Address, 1947
          </motion.p>
        </div>
      </section>

      {/* 
        SECTION 4: Mission & Philosophy 
        Style: Two-column layout with glass cards or clean typography.
      ...
      */}
      <section className="py-24 bg-[#F9FAFB] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 lg:gap-24 relative z-10">
          {/* Mission */}
          <motion.div
          ...
          >
            <h3 className="text-4xl md:text-5xl font-heading font-bold text-[#800000] mb-6">
              Our Mission
            </h3>
            <p className="text-lg text-gray-700 leading-relaxed font-medium">
              To provide students with the means for attaining their maximum
              potential through the development of intellectual, social, and
              physical skills aided with individualized attention.
            </p>
            <div className="w-16 h-1 mt-8 bg-[#DAA520]" />
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white p-10 md:p-12 rounded-3xl shadow-xl border border-gray-100 flex flex-col justify-center relative overlow-hidden group hover:shadow-2xl transition-all duration-500"
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#DAA520]/10 rounded-bl-[100px] pointer-events-none transition-transform group-hover:scale-110" />
            <h4 className="text-2xl font-bold text-gray-900 mb-4 font-serif italic">
              The &lsquo;Roots & Wings&rsquo; Philosophy
            </h4>
            <p className="text-gray-600 leading-relaxed">
              We strongly believe in providing our students with{" "}
              <span className="text-[#800000] font-bold">
                deep-rooted values
              </span>
              , knowledge, and discipline while equipping them with the skills,
              confidence, and vision to{" "}
              <span className="text-[#DAA520] font-bold">soar</span> towards a
              successful future.
            </p>
          </motion.div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 mb-16 text-center">
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-4xl md:text-5xl font-heading font-black text-gray-900 tracking-tight"
          >
            Our Core <span className="text-[#800000]">Values</span>
          </motion.h2>
          ...
          {[
            {
              ...
              desc: "Every student will be treated with fairness, dignity, and respect, regardless of race, creed, gender, religion or sect.",
            },
            {
              title: "Individual Recognition",
              desc: "Students will be valued as individuals and will not be judged based on stereotypes or preconceived notions.",
            },
            {
              title: "Inclusive Environment",
              desc: "We foster a culture of inclusivity, where diversity is celebrated, and every student feels a sense of belonging.",
            },
            {
              title: "Open Communication",
              desc: "Students are encouraged to express their thoughts and ideas freely in a supportive and respectful environment.",
            },
            {
              title: "Academic Excellence",
              desc: "We uphold the highest standards of academic excellence and integrity, ensuring equal opportunities for all.",
            },
            {
              title: "Support & Growth",
              desc: "Our institution is committed to providing a nurturing environment where students receive guidance and encouragement.",
            },
            {
              title: "Collaboration",
              desc: "We promote a spirit of teamwork and mutual respect, preparing students to work effectively in diverse environments.",
            },
            {
              title: "Empowerment",
              desc: "Students are empowered with knowledge and skills to think critically, make informed decisions, and take charge of their future.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
              ...
              className="group p-8 rounded-2xl border border-gray-100 bg-white hover:border-[#DAA520]/30 shadow-sm hover:shadow-lg transition-all duration-300 relative overflow-hidden"
            >
              <div className="absolute top-0 left-0 w-1 h-0 bg-[#800000] group-hover:h-full transition-all duration-500 ease-in-out" />
              <h4 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#800000] transition-colors">
                {item.title}
              </h4>
              <p className="text-sm text-gray-500 leading-relaxed font-medium group-hover:text-gray-700 transition-colors">
                {item.desc}
              </p>
            </motion.div>
          ))}
