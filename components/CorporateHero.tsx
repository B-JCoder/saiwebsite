        ...
        <div ref={containerRef} className="relative h-screen w-full overflow-hidden bg-black">
            ...
            >
                <div className="relative z-10">
                    <span className="text-[#DAA520] text-xl md:text-2xl font-bold uppercase tracking-widest mb-4 block">Welcome to Sir Adamjee Institute</span>
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-tight mb-6 tracking-tight">
                        Building <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#DAA520] to-yellow-200">Leaders.</span>
                    </h1>

                    <p className="text-lg md:text-2xl text-gray-200 mb-10 max-w-2xl font-light leading-relaxed">
                        Empowering the next generation with quality education and moral integrity.
                    </p>
            ...
            >
                <span className="text-xs uppercase tracking-widest opacity-80">Scroll to Explore</span>
