        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span
                className={`text-2xl font-heading font-black tracking-tighter leading-none transition-colors ${scrolled ? "text-white" : "text-white"}`}
              >
                SAI.
              </span>
              <span
                className={`text-[10px] font-bold tracking-[0.3em] uppercase transition-colors ${scrolled ? "text-accent" : "text-white/80"}`}
              >
                EST. 2004
              </span>
            </div>
