...
import { FaGraduationCap, FaAward, FaUserGraduate, FaChalkboardTeacher, FaVideo } from "react-icons/fa";
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-6 h-auto md:h-[800px]">
                ...
                >
                    ...
                    <div className="relative z-10">
                        <span className="text-accent text-xs font-bold uppercase tracking-[0.2em] mb-4 block">Who We Are</span>
                        <h2 className="text-4xl lg:text-5xl font-heading font-black text-white leading-tight mb-6">
                            We Don't Just Teach. <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-yellow-200">We Transform.</span>
                        </h2>
                        <p className="text-gray-300 leading-relaxed max-w-md">
                            Sir Adamjee Institute is more than a college. It's a launchpad for the country's brightest minds. We combine academic rigor with moral integrity.
                        </p>
                    </div>
                ...
                >
                    ...
                    <p className="text-xs text-gray-500 font-bold uppercase mt-1">Years of Excellence</p>
                </motion.div>
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-xs text-gray-400 font-bold uppercase mt-1">Alumni Network</p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <img src="/imgaes/imgi_2_Page1-scaled.jpg" alt="Campus Life" className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />

                    <div className="absolute bottom-6 left-6 z-20">
                        <div className="w-10 h-10 bg-white/20 backdrop-blur rounded-full flex items-center justify-center text-white mb-2">
                            <FaVideo />
                        </div>
                        <h3 className="text-xl font-bold text-white uppercase tracking-wider">Campus Life</h3>
                    </div>
                </motion.div>
                ...
                >
                    <div>
                        <span className="text-red-600 font-bold text-xs uppercase tracking-widest mb-1 block">Latest News</span>
                        <h3 className="text-xl font-bold text-primary mb-2 line-clamp-2">Admissions Open for Fall 2026 Session</h3>
                        <a href="/admissions" className="text-sm font-semibold text-gray-400 group-hover:text-accent transition-colors flex items-center gap-2">Apply Now →</a>
                    </div>
