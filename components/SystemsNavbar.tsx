        ...
        <>
            ...
            <div className="w-full bg-black/80 text-white/80 text-[10px] md:text-xs py-1 overflow-hidden z-50 relative border-b border-white/10">
                <div className="whitespace-nowrap animate-ticker">
                    <span className="mx-4">Admissions Open 2026 | Scholarships Available for Merit Students</span>
                    <span className="mx-4">|</span>
                    <span className="mx-4">New Campus Inauguration Soon | Visit Us Today</span>
                    <span className="mx-4">|</span>
                    <span className="mx-4">Admissions Open 2026 | Scholarships Available for Merit Students</span>
                </div>
            </div>
            ...
            <nav
                className={`fixed top-6 left-0 right-0 z-40 transition-all duration-300 ${isScrolled ? "bg-black/90 backdrop-blur-md py-3 shadow-lg" : "bg-transparent py-5"
                    }`}
            >
