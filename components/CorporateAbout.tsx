          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed font-medium">
                Sir Adamjee Institute is a premier educational institution
                dedicated to fostering academic brilliance and character
                development. We provide a rigorous learning environment that
                prepares students not just for exams, but for life.
              </p>
