          ...
          <RevealOnScroll className="lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-xl border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2.5rem] p-8 md:p-12 relative">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="uppercase text-sm font-bold text-[#DAA520] tracking-widest">
                  Principal's Desk
                </span>
              </div>
              ...
              <div className="space-y-6 text-gray-700 text-lg leading-relaxed font-medium">
                <p>
                  "At Sir Adamjee Institute, we believe that education is not
                  just about academic success; it is about shaping the character
                  and future of our students. Our mission is to provide a
                  disciplined, nurturing environment where young minds can
                  thrive."
                </p>
                <p>
                  "We are committed to modernizing education with
                  state-of-the-art facilities and a curriculum that prepares
                  students for the challenges of tomorrow."
                </p>
              </div>

              <div className="mt-10 pt-6 border-t border-[#800000]/10">
                <h4 className="text-xl font-black text-[#800000] font-heading uppercase">
                  Prof. Sohail Farooqi
                </h4>
                <p className="text-[#DAA520] font-bold text-xs uppercase tracking-widest">
